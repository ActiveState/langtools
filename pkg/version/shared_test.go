...
func TestParseGeneric(t *testing.T) {
	tests := []struct {
		...
		{"Numbers", "1", []string{"1", "0"}},
		{"Numbers", "1.0", []string{"1", "0", "0"}},
		{"Numbers", "0.92", []string{"0", "92", "0"}},
		{"Numbers", "1-1.2", []string{"1", "1", "2", "0"}},
		{"Sequential Dots", "1..2", []string{"1", "2", "0"}},
		{"Sequential Dashes", "1--2", []string{"1", "2", "0"}},
		{"Sequential Dot Dash", "1.-2", []string{"1", "2", "0"}},
		{"Uppercase A", "A1", []string{"65", "1", "0"}},
		{"Lowercase a", "a1", []string{"97", "1", "0"}},
		{"Single Unicode", "小1", []string{"23567", "1", "0"}},
		{"Ascii Word", "1.0bet", []string{"1", "0", "98.00000001010000000116", "0"}},
		{"Unicode Word", "小寸-1.1", []string{"23567.0000023544", "1", "1", "0"}},
		{"Unicode Separators", "1 2\u20013\u2002\u20034", []string{"1", "2", "3", "4", "0"}},
		{"Normalizes Unicode", "e\u0301", []string{"233", "0"}},
		{
			"Splits On Space",
		...
		{"Drops Leading Zeros", "100.02.01", []string{"100", "2", "1", "0"}},
